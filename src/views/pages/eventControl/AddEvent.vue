...
import type { CalendarDateContext } from 'primevue/calendar';
...
function setCurrentTimestamp() {
    console.log("Setting current timestamp");
        ...
        <template #content>
            ...
            <div class="grid p-fluid">
                <div class="field col-12 md:col-6">
                    <label for="eventType">Event Type</label>
                    <!-- <InputText id="eventType" v-model="eventType" placeholder="InspectionEvent or RepairEvent" /> -->
                    <Dropdown v-model="eventType" editable :options="eventTypes" optionLabel="name"
            ...
            <div class="grid p-fluid">
                <div class="field col-12 md:col-6">
                    ...
                    <div class="p-inputgroup">
                        <Calendar id="timestamp" v-model="timestamp" :showTime="true" showSeconds="true"
                            dateFormat="yy-mm-dd" hourFormat="24" class="timestamp-input" />
                    </div>
